function [M] = CRFIEKF_with_Triangular_FIS(time, model, jac, Hk , Q, R, xe0, Pe0, D, d, alpha, reg_mat)
...
fis_glc_pyrk = readfis('fuzzy_rule_glc_pyrk_Triangular');
options = evalfisOptions;
options.NumSamplePoints = 200;

fis_hk_atp_glc = readfis('fuzzy_rule_hk_atp_glc_Triangular');
options = evalfisOptions;
options.NumSamplePoints = 200;


fis_gap_g3pdh_nad = readfis('fuzzy_rule_gap_g3pdh_nad_Triangular');
options = evalfisOptions;
options.NumSamplePoints = 200;


fis_f6p_pfk1 = readfis('fuzzy_rule_f6p_pfk1_Triangular');
options = evalfisOptions;
options.NumSamplePoints = 200;
